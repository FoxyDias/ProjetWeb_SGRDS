    ...
    <div class="flex justify-between items-center">
        <img src="/img/logoDepInformatique.gif" alt="Département informatique" class="h-9 md:h-16 lg:h-18">
            ...
            <?php if (session()->get('estAdmin')): ?>
                <div class="flex items-center rounded-[12px] bg-gray-500 p-2 md:p-4 h-9 md:h-16 lg:h-18 transition ease-in-out delay-50 hover:-translate-y-1 hover:scale-110 hover:bg-gray-300 duration-300">
